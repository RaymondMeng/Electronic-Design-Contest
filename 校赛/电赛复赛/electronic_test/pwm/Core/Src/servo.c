...
{
	HAL_StatusTypeDef status = (HAL_StatusTypeDef)(Tim_SetPWM(2, 1, 1500) && Tim_SetPWM(2, 2, 1500));  
  HAL_Delay(1000);
	return status;
}
...
//  positiony_pid.set_value = pitch2_pulses + pitch3_pulses; //（默认第三题的设定值：即杆与垂直线之间的角θ算出来的对应角度，即舵机1的期望角）
